...
const deleteCurrentUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        winston_1.logger.info('Multiple blog banners deleted from Clodinary', {
            publicIds
        });
        ...
        winston_1.logger.info('User account has been deleted', { userId });
        res.sendStatus(204);
    }
    catch (err) {
        res.status(500).json({
        ...
        winston_1.logger.error('Error while deleting current user', err);
    }
});
